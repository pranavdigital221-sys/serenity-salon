  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        {/* Right: Actions & Elementor Tools */}
        <div className="flex items-center gap-1.5 sm:gap-2">
          
          {/* Elementor / WP Blueprint trigger button */}
          <button
            onClick={onOpenElementorGuide}
            title="WordPress & Elementor Conversion Kit"
            className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-[#FDF1E4] text-[#1F3A26] border border-[#C9A66B]/40 hover:bg-[#C9A66B] hover:text-white transition-all cursor-pointer mr-1"
          >
            <Code className="w-3.5 h-3.5 text-[#C9A66B] group-hover:text-white" />
            <span>WP Elementor Kit</span>
          </button>
