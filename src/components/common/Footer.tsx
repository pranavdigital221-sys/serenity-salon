      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 pb-12 border-b border-[#1F3A26]/8">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-[#6E6E6E]">
              <li>
                <a href="#privacy" className="hover:text-[#1F3A26] transition-colors">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="#terms" className="hover:text-[#1F3A26] transition-colors">
                  Terms & Conditions
                </a>
              </li>
              <li>
                <a href="#shipping-policy" className="hover:text-[#1F3A26] transition-colors">
                  Shipping & Handling
                </a>
              </li>
              <li>
                <a href="#sustainable" className="hover:text-[#1F3A26] transition-colors">
                  Eco-Glass Recycling Program
                </a>
              </li>
              <li>
                <button
                  onClick={onOpenElementorGuide}
                  className="text-[#C9A66B] font-semibold hover:underline inline-flex items-center gap-1"
                >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-[#6E6E6E]">
              ...
              <li className="text-xs text-[#6E6E6E] pt-1">
