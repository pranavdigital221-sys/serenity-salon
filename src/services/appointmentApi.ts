...
export const appointmentApi = {
  ...
  }): Promise<{ success: boolean; orderId?: string; amount?: number; error?: string; requiresConfiguration?: boolean }> {
    try {
      ...
      if (res.ok && json.success && json.orderId) {
        return { success: true, orderId: json.orderId, amount: json.amount };
      }
      return {
        success: false,
